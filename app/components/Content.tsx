...
export function Content() {
  return (
    ...
    <article>
      ...
      <p className='text-blue-300 pt-12 pb-4'><code className='font-bold'>My Stack</code></p>
      <Stack />
      ...
      <code className='text-blue-300 font-bold felx flex row items-center justify-start pt-12 pb-2'>Message me</code>
      <Form />
      <Cv />
    </article>
  )
