...
export default function About() {
    return (
        <article className='py-24 w-5/6 mx-auto'>
            <p className='text-4xl text-gray-200 font-bold mb-4'>About</p>
            <p className='text-gray-400 mb-4 lg:mb-12'>Stack & My Story</p>
            <div className='flex lg:flex-row flex-col justify-center lg:items-center gap-12'>
                <div className='lg:w-1/2'>
                    <h3 className='text-gray-200 text-lg lg:text-xl font-bold lg:font-normal lg:text-start'>Hey everyone! I start coding in 2019 building web apps for private clients using JavaScript technologies... I comfortable with React ecosystem aka <span>
                        <a href='https://www.mongodb.com/resources/languages/mern-stack' target='_blank'><span className='text-blue-300 font-bold hover:text-gray-400'>MERN</span></a></span> stack end proven patterns, that did well in production. Clean architecture and a well-chosen stack, suitable for each specific project is what makes clients happy with a final result! As you can see from my core stack - it's pretty basic end I try not to overcomplicate things end stick closer to official docs!</h3>
                </div>
